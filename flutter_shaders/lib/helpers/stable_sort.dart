 ...
 */
Process(List array, Function compare) {
  ...
  var buffer = List.from(List.generate(len.round(), (int index) => index, growable: true));
 ...
 */
RunPass(List arr, Function? comp, int chk, List result) {
  var len = arr.length;
  var i = 0;
 ...
 */
StableSort(List array, Function? compare) {
  if (compare == null) {
    compare = Compare;
  }
