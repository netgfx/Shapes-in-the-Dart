 ...
 */
  ...
  fuzzyEqualsPoints(a, b, epsilon) {
    return Utils.shared.fuzzyEqual(a.x, b.x, epsilon) && Utils.shared.fuzzyEqual(a.y, b.y, epsilon);
  }

  fuzzyEqualsXYPoints(a, x, y, epsilon) {
    return Utils.shared.fuzzyEqual(a.x, x, epsilon) && Utils.shared.fuzzyEqual(a.y, y, epsilon);
  }
